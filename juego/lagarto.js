...
{
  divElemento("jugada_humano").addEventListener("change", function(e)
  {
    if(this.value >= 1 && this.value <= 5)
    {
      var extension = ".gif";
      console.log(this.value);
      divElemento("imagenPrueba").src = "imagenes/img_" + this.value + extension;   
    }
  });
  ...
  {
    case 0:
            pc = divElemento("imagenPrueba2").src ="imagenes/img_1.gif";
    break;
    case 1:
            pc = divElemento("imagenPrueba2").src ="imagenes/img_2.gif";
    break
    case 2:
            pc = divElemento("imagenPrueba2").src ="imagenes/img_3.gif";
    break;
    case 3:
            pc =divElemento("imagenPrueba2").src ="imagenes/img_4.gif";
    break;
    case 4: 
           pc =divElemento("imagenPrueba2").src ="imagenes/img_5.gif";
    break;
  } return pc; 
};
